...
import formatError from "./functional/formatError";
...
const getPath = (filename) =>
  path.resolve(__dirname, `./personThumbImages/${filename}`);
...
test("peopleThumbs IMG_5178.JPG", (t) => {
  const person = {
    ...
    faces: [
      {
        ExternalImageId: "0eed59f0-e8b9-11e8-878c-ed97461a27ab",
        FaceId: "224ad440-e038-4fb7-914f-e763b6287e53",
      },
    ],
    ...
    landMarks: [
      { Type: "eyeLeft", X: 0.21824684739112854, Y: 0.3917418420314789 },
      { Type: "eyeRight", X: 0.36494582891464233, Y: 0.33749863505363464 },
      { Type: "nose", X: 0.21020366251468658, Y: 0.5218124985694885 },
      { Type: "mouthLeft", X: 0.26919084787368774, Y: 0.7370038628578186 },
      { Type: "mouthRight", X: 0.3647838830947876, Y: 0.7164779901504517 },
    ],
    name: "",
...
test("peopleThumbs IMG_5287.JPG", (t) => {
  const person = {
    ...
    faces: [
      {
        ExternalImageId: "4f1c03f0-e8b9-11e8-878c-ed97461a27ab",
        FaceId: "692de635-2800-47ef-95d8-4347237e93e6",
      },
    ],
...
test("peopleThumbs 2011-02-18 12.52.57.jpg", (t) => {
  const person = {
    ...
    faces: [
      {
        ExternalImageId: "7f39ac40-e8b9-11e8-878c-ed97461a27ab",
        FaceId: "1008b82d-5306-4dd3-8e49-82915ac84bcc",
      },
    ],
    ...
    landMarks: [
      { Type: "eyeLeft", X: 0.24854591488838196, Y: 0.5441654920578003 },
      { Type: "eyeRight", X: 0.2562781572341919, Y: 0.5432841777801514 },
      { Type: "nose", X: 0.2531391978263855, Y: 0.5487431287765503 },
      { Type: "mouthLeft", X: 0.2505328059196472, Y: 0.5555432438850403 },
      { Type: "mouthRight", X: 0.25715067982673645, Y: 0.5550625324249268 },
    ],
    name: "",
    thumbnail:
      "tester/2011-02-18 12.52.57-face--1008b82d-5306-4dd3-8e49-82915ac84bcc.jpg",
    userIdentityId: "us-east-1:bd054ff2-d394-496e-b602-d90103911209",
  };
...
test("peopleThumbs IMG_0181.JPG", (t) => {
  const person = {
    ...
    faces: [
      {
        ExternalImageId: "65c8f450-e73d-11e8-bdf6-675b6855f9ea",
        FaceId: "5e6d7614-290e-4555-8fd3-b07181b1b964",
      },
    ],
    ...
    landMarks: [
      { Type: "eyeLeft", X: 0.317627489566803, Y: 0.05844716727733612 },
      { Type: "eyeRight", X: 0.32313233613967896, Y: 0.05828847363591194 },
      { Type: "nose", X: 0.3425184488296509, Y: 0.07839545607566833 },
      { Type: "mouthLeft", X: 0.3147720992565155, Y: 0.10535036027431488 },
      { Type: "mouthRight", X: 0.32430121302604675, Y: 0.10457809269428253 },
    ],
    name: "",
...
test("peopleThumbs IMG_0299.JPG", (t) => {
  const person = {
    ...
    faces: [
      {
        ExternalImageId: "74f64890-e744-11e8-bdf6-675b6855f9ea",
        FaceId: "63acf58b-b9e7-40ef-a9db-680a2dbd0151",
      },
    ],
...
test("peopleThumbs 2011-03-08 16.34.33.jpg", (t) => {
  const person = {
    ...
    faces: [
      {
        ExternalImageId: "0ed34af0-e748-11e8-a1fe-950ad3f02d6e",
        FaceId: "7e54f021-ad93-4925-a5b9-f5776b2e24ea",
      },
    ],
    ...
    landMarks: [
      { Type: "eyeLeft", X: 0.5203984975814819, Y: 0.2973889410495758 },
      { Type: "eyeRight", X: 0.5931680202484131, Y: 0.3126296103000641 },
      { Type: "nose", X: 0.5503991842269897, Y: 0.3580031991004944 },
      { Type: "mouthLeft", X: 0.5196753740310669, Y: 0.4044731855392456 },
      { Type: "mouthRight", X: 0.5690034031867981, Y: 0.41630202531814575 },
    ],
    name: "",
    thumbnail:
      "tester/2011-03-08 16.34.33-face--7e54f021-ad93-4925-a5b9-f5776b2e24ea.jpg",
    userIdentityId: "us-east-1:8705ff8e-0c46-46e7-b969-baebe2a384fb",
  };
  ...
  const people = [
    {
      ...
      faces: [
        {
          ExternalImageId: "51f1c940-e745-11e8-be21-dd8825657520",
          FaceId: "1c8ad7d9-7e9c-448c-9bc7-c07cbafa697a",
        },
      ],
      ...
      landMarks: [
        { Type: "eyeLeft", X: 0.7807751893997192, Y: 0.08210083097219467 },
        { Type: "eyeRight", X: 0.8148456811904907, Y: 0.09312696754932404 },
        { Type: "nose", X: 0.7904192209243774, Y: 0.11383534967899323 },
        { Type: "mouthLeft", X: 0.7734729051589966, Y: 0.12488206475973129 },
        { Type: "mouthRight", X: 0.8071706891059875, Y: 0.13484737277030945 },
      ],
      name: "",
      thumbnail:
        "tester/2011-02-11 11.09.37[0]-face--1c8ad7d9-7e9c-448c-9bc7-c07cbafa697a.jpg",
      userIdentityId: "us-east-1:8705ff8e-0c46-46e7-b969-baebe2a384fb",
    },
    {
      boundingBox: {
      ...
      faces: [
        {
          ExternalImageId: "51f1c940-e745-11e8-be21-dd8825657520",
          FaceId: "2e036075-62fa-4275-acdf-a577b8613cb6",
        },
      ],
      ...
      img_key: "tester/2011-02-11 11.09.37[0].jpg",
      landMarks: [
        { Type: "eyeLeft", X: 0.654455304145813, Y: 0.1148969978094101 },
        { Type: "eyeRight", X: 0.674835741519928, Y: 0.12100327759981155 },
        { Type: "nose", X: 0.6587437987327576, Y: 0.1350855827331543 },
        { Type: "mouthLeft", X: 0.6581385135650635, Y: 0.1448759287595749 },
        { Type: "mouthRight", X: 0.6720491051673889, Y: 0.14795662462711334 },
      ],
      name: "",
      thumbnail:
        "tester/2011-02-11 11.09.37[0]-face--2e036075-62fa-4275-acdf-a577b8613cb6.jpg",
      userIdentityId: "us-east-1:8705ff8e-0c46-46e7-b969-baebe2a384fb",
    },
  ];
...
test("peopleThumbs IMG_5184.JPG", (t) => {
  const person = {
    ...
    faces: [
      {
        ExternalImageId: "f9a26c00-e73e-11e8-bdf6-675b6855f9ea",
        FaceId: "3d519a0d-38dc-4fce-85a7-fcd60c7df8ca",
      },
    ],
    ...
    landMarks: [
      { Type: "eyeLeft", X: 0.3967800736427307, Y: 0.15808381140232086 },
      { Type: "eyeRight", X: 0.472261518239975, Y: 0.1498555690050125 },
      { Type: "nose", X: 0.42047587037086487, Y: 0.1875104308128357 },
      { Type: "mouthLeft", X: 0.41617122292518616, Y: 0.22922451794147491 },
      { Type: "mouthRight", X: 0.48183658719062805, Y: 0.2229016274213791 },
    ],
    name: "",
...
test("peopleThumbs IMG_5195.JPG", (t) => {
  const person = {
    ...
    faces: [
      {
        ExternalImageId: "82b5ab60-e73f-11e8-bdf6-675b6855f9ea",
        FaceId: "4f2d3f5e-bf11-483d-8000-5c870dacb5e5",
      },
    ],
    ...
    landMarks: [
      { Type: "eyeLeft", X: 0.4717758595943451, Y: 0.15128810703754425 },
      { Type: "eyeRight", X: 0.5398473739624023, Y: 0.1467871069908142 },
      { Type: "nose", X: 0.4973805248737335, Y: 0.1792473942041397 },
      { Type: "mouthLeft", X: 0.4921362102031708, Y: 0.19644282758235931 },
      { Type: "mouthRight", X: 0.5531346201896667, Y: 0.1902041882276535 },
    ],
    name: "",
...
test("peopleThumbs IMG_5102.JPG", (t) => {
  const person = {
    ...
    faces: [
      {
        ExternalImageId: "b74614d0-e8b8-11e8-878c-ed97461a27ab",
        FaceId: "0cb9e2f2-634b-4654-88a6-e7113098ceb0",
      },
    ],
    ...
    landMarks: [
      { Type: "eyeLeft", X: 0.2755873203277588, Y: 0.2704360783100128 },
      { Type: "eyeRight", X: 0.3858790695667267, Y: 0.25940224528312683 },
      { Type: "nose", X: 0.36730313301086426, Y: 0.3207150995731354 },
      { Type: "mouthLeft", X: 0.2741638422012329, Y: 0.3484114110469818 },
      { Type: "mouthRight", X: 0.3821982145309448, Y: 0.34000590443611145 },
    ],
    name: "",
